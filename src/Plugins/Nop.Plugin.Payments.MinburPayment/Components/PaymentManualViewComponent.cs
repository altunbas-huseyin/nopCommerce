...
{
    [ViewComponent(Name = "PaymentMinbur")]
    public class PaymentMinburViewComponent : NopViewComponent
    {
        public IViewComponentResult Invoke()
        {
            ...
            return View("~/Plugins/Payments.MinburPayment/Views/PaymentInfo.cshtml", model);
        }
    }
